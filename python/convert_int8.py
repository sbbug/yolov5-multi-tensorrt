...
if __name__ == '__main__':
    ...
    parser.add_argument('--onnx_file', default='./lib/models/yolov5s-visible-prune.onnx', help='onnx file location')
    parser.add_argument('--calibration_table', default='yolov5s_calibration.cache', help='calibration cache')
    parser.add_argument('--engine_file', default='./lib/models/yolov5s_int8_prune.trt', help='name of trt output file')
    parser.add_argument('--data_path', default='/home/user/Code/yolov5-tensorrt-master/python/calibrator_imgs',
                        help='calibration images')
    parser.add_argument('--batch_size', type=int, default=1, help='batch_size')
    parser.add_argument('--height', type=int, default=672, help='model input h')
    parser.add_argument('--width', type=int, default=672, help='model input w')
